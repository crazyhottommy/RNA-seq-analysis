...
A biostar [post](https://www.biostars.org/p/143458/#157303): **Do not feed rounded estimates of gene counts from kallisto into DESeq2** (please make sure you read througt all the comments, and now there is a suggested workflow for feeding rounded estimates of gene counts to DESeq etc)   
